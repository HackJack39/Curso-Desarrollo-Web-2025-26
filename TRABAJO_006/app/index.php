...
/**
 * Archivo: index.php
 * Formulario principal protegido con conexión a PostgreSQL
 */

// 1. AÑADIR SESSION_START() AL PRINCIPIO
session_start();

// 2. LÓGICA DE PROTECCIÓN: Si el usuario NO está logueado, lo enviamos al login.
...
<head>
    ...
    <title>Panel de Administración</title> <link rel="stylesheet" href="/CSS/styles.css">
    
</head>
<body>
    <div class="container">
        <div class="header">
            <h1>🔒 Panel de Administración (TRABAJO_006)</h1>
            <p>Formulario de Registro con Docker Compose, PHP 8.2 y PostgreSQL 16</p>
            <div class="user-info">
                Bienvenido, **<?= htmlspecialchars($_SESSION['username'] ?? 'Usuario') ?>** | 
        ...
        <div class="grid">
            ...
            <div class="card">
                ...
                <h3 style="color: #764ba2; margin-bottom: 15px; font-size: 1.1em;">📚 Cursos Disponibles</h3>
