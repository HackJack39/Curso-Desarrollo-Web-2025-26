...
<link href="https://fonts.googleapis.com/css2?family=Lora:wght@400;700&family=Merriweather+Sans:wght@400;700&display=swap" rel="stylesheet">
...
<div class="container">
    ...
    <div class="stats-grid">
        <div class="card stat-card stat-alumnos">
            <h4>Alumnos</h4>
            <p class="stat-value"><?= $totalAlumnos ?></p>
        </div>
        <div class="card stat-card stat-cursos">
            <h4>Cursos</h4>
            <p class="stat-value"><?= $totalCursos ?></p>
        </div>
        <div class="card stat-card stat-usuarios">
            <h4>Usuarios</h4>
